================================================================
Cloud Drive Worker – UNIFIED CONSTITUTIONAL MASTER SPEC v7.33
REBUILT FULL EDITION (FSM PERSISTENCE + INDEX/HARDENING ALIGNMENT)
================================================================
...
Release (canonical):
- Spec Version: v7.33
- Canonical Path: constitution/v7.33.md
- Baseline: v7.30 REBUILT FULL EDITION (historical label; see changelog below)
- Status: Frozen Single Source of Truth (SSoT)

This document is a clean rebuild (single-source, no legacy layers).
All invariants are defined exactly once in Part I.
All other sections reference Part I rather than restating rules.

----------------------------------------------------------------
Changelog (historical, baseline lineage)
----------------------------------------------------------------

CHANGELOG (v7.29 → v7.30)
- ADD: ULID-format CHECK constraints for all domain ID columns in schema (best-effort),
  including colon-forbid where applicable.
- CLARIFY: ID grammar contract section added
  (ULID = 26-char Crockford Base32 uppercase; ':' forbidden in all non-composite IDs).

CHANGELOG (v7.28 → v7.29)
- ADD: entity_id contract hardened: ':' is forbidden for non-composite IDs;
  mount composite must be exact and tokens must be ULIDs.
- CLARIFY: audit_log entity_id CHECK constraints added as best-effort DB enforcement
  (API validation remains authoritative).
- CLARIFY: All FOREIGN KEY relations declare explicit ON DELETE behavior
  (default is RESTRICT unless stated).

================================================================
PART I – CORE INVARIANTS (IMMUTABLE)
================================================================
...
================================================================
END OF BASELINE SPECIFICATION (v7.30)
Baseline preserved for lineage. Continuing with v7.31–v7.33 patches below.
================================================================

================================================================
PART X – CONSTITUTIONAL HARDENING PATCHES (v7.31 → v7.33)
These patches are additive constraints on top of the v7.30 baseline.
The effective constitution version of this document is v7.33.
================================================================
